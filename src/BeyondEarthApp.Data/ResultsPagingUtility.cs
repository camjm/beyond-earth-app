...
{
    /// <summary>
    /// Encapsulates logic to restrict page numbers and sizes to reasonable values. 
    /// All invalid user input shoud have been corrected by this point in processing.
    /// </summary>
    public static class ResultsPagingUtility
    {
        ...
        public static int CalculateStartIndex(int pageNumber, int pageSize)
        {
            if (pageNumber < 1)
            {
                //TODO: should not use Constants, use string literal!
